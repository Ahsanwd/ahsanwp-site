  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-16 sm:py-20">
        <div className="space-y-6 sm:space-y-8">
          {services.map((service, i) => (
            <FadeIn key={service.title} delay={i * 0.06}>
              <div className="group grid gap-6 rounded-2xl border border-zinc-200 p-6 transition-all hover:-translate-y-1 hover:border-indigo-300 hover:shadow-xl hover:shadow-indigo-500/10 sm:p-8 sm:grid-cols-[1fr_1.2fr] dark:border-zinc-800 dark:hover:border-indigo-800">
                <div>
                  ...
                  <h2 className="mt-4 text-lg font-semibold text-zinc-950 sm:text-xl dark:text-white">{service.title}</h2>
        ...
        <FadeIn className="mt-14 rounded-2xl bg-zinc-50 p-8 text-center sm:mt-16 sm:p-10 dark:bg-zinc-950">
