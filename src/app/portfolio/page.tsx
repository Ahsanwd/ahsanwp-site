  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-16 sm:py-20">
        ...
        <FadeIn className="mt-16 rounded-2xl border border-dashed border-zinc-300 p-8 text-center sm:mt-24 sm:p-10 dark:border-zinc-700">
          <h2 className="text-lg font-semibold text-zinc-950 sm:text-xl dark:text-white">
